...
import { StyleSheet, Animated, Text, View, SafeAreaView, Dimensions, Image, TouchableOpacity, Keyboard, TouchableWithoutFeedback } from "react-native";
    ...
    return (
        <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
            <SafeAreaView style={styles.container}>
                <Animated.View style={[styles.animatedContainer, { opacity: fadeInAnim }]}>
                    ...
                    <View style={styles.containerText}>
                        <Animated.View style={[styles.errorContainer, { opacity: fadeAnim, transform: [{ translateY }], display: error ? "flex" : "none" }]}>
                        ...
                        <View style={styles.containerform}>
                            ...
                            <View style={styles.registerContainer}>
                                <Text style={styles.registerText}>¿Aún no tienes cuenta en GOU!?</Text>
                                <CustomButton title="Registrarse" onPress={() => navigation.navigate("Info")} />
                            </View>
                        </View>
                    </View>
                </Animated.View>
